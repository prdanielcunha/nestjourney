...
export const journeyOverviewCopy = {
  'pt-BR': {
    ...
    discipleship: 'Discipulado', activeRelations: 'relações ativas', implementation: 'Implantação', implementationWeek: 'semana', implementationCompleted: 'ciclo concluído', implementationNotStarted: 'ciclo ainda não iniciado', restricted: 'Lens restrita', unavailable: 'Fonte não consultada',
    peopleAction: 'Journey Profile', careAction: 'Care Integrity', presenceAction: 'Presence Assist', groupsAction: 'Groups Runtime', discipleshipAction: 'Discipleship Runtime', implementationAction: 'Implantação guiada',
  ...
  en: {
    ...
    discipleship: 'Discipleship', activeRelations: 'active relationships', implementation: 'Implementation', implementationWeek: 'week', implementationCompleted: 'cycle completed', implementationNotStarted: 'cycle not started yet', restricted: 'Restricted Lens', unavailable: 'Source not queried',
    peopleAction: 'Journey Profile', careAction: 'Care Integrity', presenceAction: 'Presence Assist', groupsAction: 'Groups Runtime', discipleshipAction: 'Discipleship Runtime', implementationAction: 'Guided implementation',
  ...
  es: {
    ...
    discipleship: 'Discipulado', activeRelations: 'relaciones activas', implementation: 'Implementación', implementationWeek: 'semana', implementationCompleted: 'ciclo concluido', implementationNotStarted: 'ciclo aún no iniciado', restricted: 'Lens restringida', unavailable: 'Fuente no consultada',
    peopleAction: 'Journey Profile', careAction: 'Care Integrity', presenceAction: 'Presence Assist', groupsAction: 'Groups Runtime', discipleshipAction: 'Discipleship Runtime', implementationAction: 'Implementación guiada',
