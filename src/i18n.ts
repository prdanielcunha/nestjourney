...
export const careIntegrityCopy = {
  ...
  en: {
    ...
    manual: 'created manually', claim: 'Claim care', openFollowup: 'Open first contact', recordOutcome: 'Record outcome', unknownPerson: 'Person not found',
  ...
  es: {
    ...
    manual: 'creado manualmente', claim: 'Asumir cuidado', openFollowup: 'Abrir primer contacto', recordOutcome: 'Registrar resultado',
    ...
    resolutions: { contact_completed: 'Contacto concluido', pastoral_handoff: 'Derivado al pastor', declined_contact: 'La persona no desea contacto', invalid_contact: 'Contacto inválido', closed_no_response: 'Cerrado sin respuesta', other_resolved: 'Otro resultado concluido' },
  },
} as const
...
export const followupRuntimeCopy = {
  'pt-BR': {
    ...
    outcomes:{responded:'Respondeu',prayer_requested:'Pediu oração',group_interest:'Demonstrou interesse em grupo',declined_contact:'Não deseja contato',invalid_contact:'Contato inválido',no_response:'Sem resposta'},
  ...
  en: {
    ...
    outcomes:{responded:'Replied',prayer_requested:'Requested prayer',group_interest:'Expressed interest in a group',declined_contact:'Does not want contact',invalid_contact:'Invalid contact',no_response:'No response'},
  ...
  es: {
    ...
    outcomes:{responded:'Respondió',prayer_requested:'Pidió oración',group_interest:'Mostró interés en un grupo',declined_contact:'No desea contacto',invalid_contact:'Contacto inválido',no_response:'Sin respuesta'},
