...
export const followupRuntimeCopy = {
  'pt-BR': {
    ...
    back:'Voltar ao Care Integrity', loading:'Carregando acompanhamentos…', noAccessTitle:'Acompanhamentos não disponíveis',
    ...
    promise:'Care Promise', start:'Preparar contato no Connect', onlyOwner:'Somente o responsável', noReady:'Nenhum primeiro contato atribuído aguardando início.',
    ...
    sourceRule:'NO SOURCE → NO CLAIM: “contato concluído” só aparece após um resultado humano registrado. O sistema não infere interesse, fé, humor ou vínculo pela ausência de resposta.',
    ...
    invalidSource:'Este cuidado não é um primeiro contato aberto.', missingCare:'A Care Promise de origem não foi encontrada.', unknownPerson:'Pessoa não encontrada',
    cancel:'Cancelar', complete:'Concluir acompanhamento', error:'Não foi possível concluir a operação.',
    closeRevoked:'Encerrar sem contato', revokedHint:'A autorização de contato foi removida. Não abra o Connect; encerre este acompanhamento de forma factual.',
  ...
  en: {
    ...
    back:'Back to Care Integrity', loading:'Loading follow-ups…', noAccessTitle:'Follow-ups unavailable',
    ...
    promise:'Care Promise', start:'Prepare contact in Connect', onlyOwner:'Owner only', noReady:'No assigned first contact is waiting to start.',
    ...
    sourceRule:'NO SOURCE → NO CLAIM: “contact completed” appears only after a human records an outcome. The system does not infer interest, faith, mood, or belonging from no response.',
    ...
    invalidSource:'This care item is not an open first contact.', missingCare:'The source Care Promise could not be found.', unknownPerson:'Person not found',
    cancel:'Cancel', complete:'Complete follow-up', error:'The operation could not be completed.',
    closeRevoked:'Close without contact', revokedHint:'Contact authorization was removed. Do not open Connect; close this follow-up with a factual outcome.',
  ...
  es: {
    ...
    back:'Volver a Care Integrity', loading:'Cargando acompañamientos…', noAccessTitle:'Acompañamientos no disponibles',
    ...
    promise:'Care Promise', start:'Preparar contacto en Connect', onlyOwner:'Solo responsable', noReady:'No hay primeros contactos asignados esperando inicio.',
    ...
    sourceRule:'NO SOURCE → NO CLAIM: “contacto concluido” aparece solo después de que una persona registra un resultado. El sistema no infiere interés, fe, ánimo ni vínculo por falta de respuesta.',
    ...
    invalidSource:'Este cuidado no es un primer contacto abierto.', missingCare:'No se encontró la Care Promise de origen.', unknownPerson:'Persona no encontrada',
    cancel:'Cancelar', complete:'Concluir acompañamiento', error:'No se pudo completar la operación.',
    closeRevoked:'Cerrar sin contactar', revokedHint:'La autorización de contacto fue retirada. No abras Connect; cierra este acompañamiento con un resultado factual.',
