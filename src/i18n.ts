...
export const journeyOverviewCopy = {
  'pt-BR': {
    ...
    peopleAction: 'Journey Profile', careAction: 'Care Integrity', presenceAction: 'Presence Assist', groupsAction: 'Groups Runtime', discipleshipAction: 'Discipleship Runtime', implementationAction: 'Implementación guiada', implementationAction: 'Guided implementation', implementationAction: 'Implantação guiada',
