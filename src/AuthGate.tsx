...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  if (ecosystem.status === 'loading') return <div className="auth-screen auth-loading"><img src="/icon.svg" alt="" /><LoaderCircle /><p>Conectando ao ecossistema MillionsNest…</p></div>
  ...
  return <main className="auth-screen">
    <section className="auth-story"><div className="auth-brand"><img src="/icon.svg" alt="" /><span><strong>{PRODUCT_NAME}</strong><small>um produto MillionsNest</small></span></div><div className="auth-copy"><span className="eyebrow">CUIDADO QUE CONTINUA</span><h1>Pessoas ao lado de pessoas.</h1><p>Organize jornadas de acolhimento, cuidado, comunidade e formação sem transformar histórias em números.</p></div><div className="auth-trust"><ShieldCheck /><span><strong>Uma conta para todo o ecossistema</strong><small>Mesma igreja, equipe e permissões dos seus outros aplicativos MillionsNest.</small></span></div></section>
