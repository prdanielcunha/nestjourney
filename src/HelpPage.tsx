...
import { NESTJOURNEY_IS_BETA, NESTJOURNEY_VERSION } from './releaseInfo'
...
export default function HelpPage(){
  ...
  return <main className="journey-section-page"><div className="journey-section-shell">
    ...
    <div className="journey-section-note"><BookOpen size={18}/><p><strong>{t.version}: {NESTJOURNEY_VERSION}</strong>{NESTJOURNEY_IS_BETA?<> · {t.beta}</>:null} · <a href="/whats-new">{locale==='pt-BR'?'Ver novidades':locale==='es'?'Ver novedades':"See what's new"}</a></p></div>
  </div></main>
}
