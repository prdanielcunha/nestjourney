...
const roleCopy:Record<AppLocale,Record<JourneyResponsibility,{title:string;focus:string}>>={
  'pt-BR':{
    ...
    pastor:{title:'Pastor',focus:'Priorize Cuidado atrasado, encaminhamentos pastorais e jornadas que precisam de decisão ou cuidado pastoral.'},
    ...
    member:{title:'Membro',focus:'Use Minha Jornada para Pulse voluntário, encontrar uma Casa, atualizar contato e acessar canais seguros sem precisar de uma função operacional.'},
  },
  en:{
    ...
    member:{title:'Member',focus:'Use My Journey for voluntary Pulse, finding a House, updating contact, and safe channels without needing an operational role.'},
  },
  es:{
    ...
    pastor:{title:'Pastor',focus:'Prioriza Cuidado atrasado, derivaciones pastorales y jornadas que necesitan decisión o cuidado pastoral.'},
...
export default function HelpPage(){
  ...
  const cards=[
    ...
    responsibility==='member'?{title:t.memberJourney,desc:t.memberJourneyDesc,href:'/my-journey',Icon:HeartHandshake}:null,
    access&&canViewJourneyPeople(access)?{title:t.people,desc:t.peopleDesc,href:'/journey-profile',Icon:UsersRound}:null,
    responsibility!=='member'?{title:t.areas,desc:t.areasDesc+' '+areaNames,href:'/areas',Icon:HeartHandshake}:null,
