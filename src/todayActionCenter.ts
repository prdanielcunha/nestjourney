...
const copy: Record<AppLocale, Copy> = {
  'pt-BR': {
    ...
    items: {
      ...
      care_due_soon: { title: 'Há um cuidado vencendo em breve', body: 'O prazo de 24–48h está próximo. Entre em contato antes que isso vire Care Debt.', cta: 'Abrir cuidado', href: '/care-integrity' },
    ...
    role: {
      ...
      pastor: { title: 'Veja onde sua decisão pastoral é necessária', body: 'Leia Care Debt, encaminhamentos e jornadas sem próximo passo factual em uma visão curta da unidade.', cta: 'Abrir Visão', href: '/vision' },
      ...
      ceo: { title: 'Compare organizações e unidades', body: 'Use a Visão executiva para trocar de organização, ler unidades e entrar apenas onde existe atenção real.', cta: 'Abrir Visão executiva', href: '/vision' },
      member: { title: 'Encontre o que está disponível para você', body: 'Abra Áreas para ver somente os módulos permitidos pelo seu papel e entender onde começar.', cta: 'Ver Áreas', href: '/areas' },
    },
  },
  en: {
    now: 'Do this now',
    ...
    items: {
      ...
      care_due_soon: { title: 'Care is due soon', body: 'The 24–48h promise is close. Reach out before it becomes Care Debt.', cta: 'Open care', href: '/care-integrity' },
    ...
    role: {
      ...
      pastor: { title: 'See where pastoral decision is needed', body: 'Read Care Debt, handoffs, and journeys without a factual next step in one concise campus view.', cta: 'Open Vision', href: '/vision' },
      ...
      ceo: { title: 'Compare organizations and campuses', body: 'Use executive Vision to switch organizations, read campuses, and enter only where attention is real.', cta: 'Open executive Vision', href: '/vision' },
      member: { title: 'Find what is available to you', body: 'Open Areas to see only modules permitted by your role and understand where to begin.', cta: 'View Areas', href: '/areas' },
    },
  },
  es: {
    now: 'Haz esto ahora',
    ...
    items: {
      ...
      care_due_soon: { title: 'Hay un cuidado por vencer', body: 'El plazo de 24–48h está cerca. Contacta antes de que se convierta en Care Debt.', cta: 'Abrir cuidado', href: '/care-integrity' },
    ...
    role: {
      ...
      pastor: { title: 'Ve dónde hace falta una decisión pastoral', body: 'Lee Care Debt, derivaciones y jornadas sin próximo paso factual en una vista breve de la sede.', cta: 'Abrir Visión', href: '/vision' },
      ...
      ceo: { title: 'Compara organizaciones y sedes', body: 'Usa la Visión ejecutiva para cambiar de organización, leer sedes y entrar solo donde haya atención real.', cta: 'Abrir Visión ejecutiva', href: '/vision' },
      member: { title: 'Encuentra lo disponible para ti', body: 'Abre Áreas para ver solo los módulos permitidos por tu rol y entender dónde empezar.', cta: 'Ver Áreas', href: '/areas' },
    },
  },
}
